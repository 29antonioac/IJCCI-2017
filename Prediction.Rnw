...
<<MeasuresGraphics, fig.cap = "Obtained measures with all models", fig.env = "figure", fig.height = 7>>=
...
<<TimeComparisonAcc, fig.cap = "Classifiers comparative over time", fig.height = 8 >>=
